...
// function displayUserSettings(setting){
//   const theme = sttings?.theme ?? "light";
//   const fontSize = sttings?.fontSize ?? 14;
//   const notificatons = sttings?.notificatons ?? true;

//   console.log("Настройки пользователя:");
//   console.log("Тема:", theme);
//   console.log("Размер шрифта", fontSize);
//   console.log("Уведомления",  notificatons);
// }

// displayUserSettings({theme: "dark", fontSize: 16});
// displayUserSettings({notificatons: false});
// displayUserSettings({});
...
const order = {
  customer: {
    name: "Вика Тектова",
    email: "vikatekutova@gmail.com",
    phone: "+7 917 641-58-68",
  },
  shipping: {
    address: {
      city: "Куйбышев",
